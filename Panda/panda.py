...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_lookup_tables',
                        default='/content/drive/MyDrive/anomaly_detection/data/rsna/8-frame-data-train-med/lookup_table.csv')
    parser.add_argument('--test_lookup_tables',
                        default='/content/drive/MyDrive/anomaly_detection/data/rsna/8-frame-data-test-med/lookup_table.csv')
