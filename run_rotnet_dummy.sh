...
python ./train.py --epochs=25 --train_set=0 --train_lookup_table=$train_path --test_lookup_table=$test_path
python ./test.py --train_set=0 --anomal_lookup_table=$anomal_path --normal_lookup_table=$normal_path